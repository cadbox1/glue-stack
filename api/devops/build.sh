...
docker pull $API_DEPENDENCIES_IMAGE_TAG:latest || true
...
docker build -t $API_IMAGE_NAME:$TAG $API_IMAGE_NAME:latest --cache-from $API_DEPENDENCIES_IMAGE_NAME:latest ../
